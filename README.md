# @mytake2/feature-flag-client

[![NPM Version](https://img.shields.io/npm/v/@mytake2/feature-flag-client)](https://npmjs.com/package/@mytake2/feature-flag-client) [![NPM Version](https://img.shields.io/npm/dw/@mytake2/feature-flag-client)](https://npmjs.com/package/@mytake2/feature-flag-client) [![NPM Version](https://img.shields.io/bundlephobia/min/@mytake2/feature-flag-client)](https://npmjs.com/package/@mytake2/feature-flag-client)
...
```bash
    npm install @mytake2/feature-flag-client
```
...
Package releases are started by manually triggering the [Bump Version](https://github.com/mytake2/feature-flag-client/actions/workflows/bump-version.yml) GitHub Action. The Bump Version action will create a release commit with the version bump and an associated git tag, and automatically start the [Build and Publish](https://github.com/mytake2/feature-flag-client/actions/workflows/build-and-publish.yml) GitHub Action. The Build and Publish action requires a manual approval step from a repository admin. Once approved, the package will be published to the NPM registry.

## Support

Please create a PR if you find any missing functionality that you's like to add. For bugs, please use the [issues tracker](https://github.com/mytake2/feature-flag-client/issues). I'd be happy to help you!
